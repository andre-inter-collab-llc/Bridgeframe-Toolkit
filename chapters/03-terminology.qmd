...
### The Complete BA-PH Process Workflow
...
```{mermaid}
%%| label: fig-ba-ph-process
%%| fig-cap: "Business Analyst Process Mapped to Public Health Analyst Workflow"
%%| fig-width: 10
