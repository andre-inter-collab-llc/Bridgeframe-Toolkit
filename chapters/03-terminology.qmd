...
### Data Architecture: Medallion Architecture for Public Health
...
#### Mapping Medallion Layers to Public Health
...
::: {.callout-tip title="Desktop Analogy"}
...
Different team members interact with different layers based on their roles and responsibilities:

| Layer | BA/IT Users | Public Health Users |
|:------|:------------|:--------------------|
| **Bronze** | Data engineers, operations teams, compliance/audit | Data managers, data stewards, IT operations, security officers |
| **Silver** | Data engineers, data analysts, data scientists | Epidemiologists (detailed analysis), cancer registrars, data quality analysts |
| **Gold** | BI developers, ML engineers, executives | Contact tracers, program managers, leadership, partner agencies, the public (via dashboards) |

#### What Layer Does a Line List Belong To?
...
::: {.callout-tip title="Translation Tip"}
