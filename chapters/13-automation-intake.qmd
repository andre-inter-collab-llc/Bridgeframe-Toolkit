...
A well-structured submission describes the context, the role, and what needs to happen, similar to the structured requirement formats discussed in @sec-when-standard-user-stories-fall-short. Standard **User Stories**, **Given-Person-Should (GPS)**, and **Situational Protocol** formats all work well:
...
Complete the [Public Health Automation Clinic Intake Form](https://forms.gle/PLACEHOLDER){target="_blank"} describing your problem. You can submit anonymously or provide contact information for follow-up. The more detail you provide, the faster and more accurately we can develop a solution.
...
- **Sample Data**: Can you provide a de-identified example of the input and expected output?
- **Contact Preference**: Anonymous submission, or would you like follow-up?

### Setting Expectations

::: {.callout-note title="Free Service Guidelines"}
- **No guaranteed timelines.** Submissions are addressed as capacity allows.
...
- **Solutions are provided as-is.** Scripts and tools come with documentation but without ongoing support or maintenance commitments.
:::

### Paid Services for Urgent Needs

If you have a task that is time-sensitive, requires dedicated attention, or involves more complex integration work, [Intersect Collaborations](https://www.intersectcollaborations.com/) offers paid consulting services. Paid engagements include:
...
To inquire about paid services, contact André van Zyl directly through [Intersect Collaborations](https://www.intersectcollaborations.com/) or [LinkedIn](https://www.linkedin.com/in/andre-van-zyl/).

## The Automation Mindset

Submitting a problem to the clinic is valuable even if the solution is simple. The act of describing a manual process in structured terms is itself the first step toward optimization. As discussed in @sec-optimization-hierarchy, the optimization hierarchy applies here:
...
**[Complete the Intake Form](https://forms.gle/PLACEHOLDER){target="_blank"}**
...
If your need is urgent or involves complex systems integration, [contact Intersect Collaborations](https://www.intersectcollaborations.com/) for paid consulting services.
