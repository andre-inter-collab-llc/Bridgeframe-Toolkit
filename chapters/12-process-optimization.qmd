...
%%| fig-width: 10
flowchart TB
    subgraph Foundations["<b>Foundational Factors</b>"]
        direction TB
        PSY["<b>Psychological<br/>Foundations</b><br/>• SDT (Autonomy,<br/>Competence, Relatedness)<br/>• Psychological Safety<br/>• JD-R Balance"]
        SOC["<b>Sociological<br/>Foundations</b><br/>• Organizational Culture<br/>• Communities of Practice<br/>• Power Structures"]
        EDU["<b>Educational<br/>Foundations</b><br/>• Adult Learning (Andragogy)<br/>• Technical Capacity<br/>• Knowledge Management"]
    end

    subgraph Enablers["<b>Enabling Factors</b>"]
        direction TB
        E1["Clear Governance<br/>& Accountability"]
        E2["Transparent<br/>Communication"]
        E3["Iterative<br/>Development"]
        E4["Centralized<br/>Core Functions"]
        E5["Thoughtful<br/>Automation"]
        E6["Scripted<br/>Workflows"]
    end

    subgraph Barriers["<b>Barriers & Risks</b>"]
        direction TB
        B1["Bullying &<br/>Intimidation"]
        B2["Political<br/>Interference"]
        B3["Knowledge<br/>Silos"]
        B4["Duplicated<br/>Effort"]
        B5["Rigid or Opaque<br/>Automation"]
        B6["Ambiguous<br/>Accountability"]
        B7["Goal Drift &<br/>Scope Creep"]
        B8["Resistance<br/>to Change"]
    end

    subgraph Processes["<b>Organizational Processes</b>"]
        direction TB
        P1["Project<br/>Management"]
        P2["Change<br/>Management"]
        P3["Data<br/>Management"]
        P4["Quality<br/>Improvement"]
    end

    subgraph Outcomes["<b>Intermediate Outcomes</b>"]
        direction TB
        O1["Operational<br/>Efficiency"]
        O2["Data<br/>Quality"]
        O3["Staff<br/>Well-being"]
        O4["System<br/>Adoption"]
    end

    subgraph Impact["<b>Ultimate Impact</b>"]
        direction TB
        I1(["<b>Public Health<br/>Program Impact</b>"])
        I2(["<b>Taxpayer<br/>Value</b>"])
    end

    %% Foundations to Enablers (positive paths)
    PSY -->|supports| E1
    PSY -->|supports| E2
    SOC -->|enables| E4
    SOC -->|enables| E2
    ...
    %% Foundations to Barriers (when absent/weak)
    PSY -.->|when absent| B1
    PSY -.->|when absent| B8
    SOC -.->|dysfunction| B2
    SOC -.->|dysfunction| B3
    ...
    class E1,E2,E3,E4,E5,E6 enabler
    class B1,B2,B3,B4,B5,B6,B7,B8 barrier
...
The diagram above illustrates the causal pathways between factors affecting public health program optimization:

| Layer | Description |
|:------|:------------|
| **Foundational Factors** (blue) | Psychological, sociological, and educational foundations that underpin all organizational activity. When strong, they enable positive factors; when weak or absent, they create barriers. |
| **Enabling Factors** (green) | Organizational capabilities and practices that drive efficiency. These include governance, communication, iterative development, centralization, and automation. |
| **Barriers & Risks** (red) | Dysfunction patterns that impede optimization. These arise from foundational weaknesses or poor organizational choices. |
| **Organizational Processes** (orange) | Core operational activities where enablers and barriers interact: project management, change management, data management, and quality improvement. |
| **Intermediate Outcomes** (purple) | Measurable results of effective processes: operational efficiency, data quality, staff well-being, and system adoption. |
| **Ultimate Impact** (dark blue) | The end goals: public health program impact and demonstrated taxpayer value. |

**Key relationships:**

- **Solid arrows** (→) represent positive causal pathways where one factor supports or enables another
- **Dashed arrows** (-..->) represent negative pathways where absence, dysfunction, or barriers undermine processes
