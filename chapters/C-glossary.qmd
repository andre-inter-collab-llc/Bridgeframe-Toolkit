...
: Harmful behaviors that intimidate or belittle staff, leading to silence and errors. **Response**: Enforce anti-bullying policies, focus on behaviors, provide anonymous reporting and HR escalation.
...
: Reluctance to adopt new tools or approaches due to fear, uncertainty, or perceived loss of control. **Mitigation**: Co-design, pilots, training, incentives, and visible leadership support.
...
: Concerns about maladaptive patterns impacting decisions and team health. Avoid diagnosing in workplace contexts; focus on observable behaviors and enforce conduct standards. Use HR processes and governance to protect staff and operations.

**Political Factors** (Organizational)
: Formal and informal power dynamics that influence decisions beyond evidence considerations. **Guardrails**: Transparent criteria, decision logs, conflict-of-interest declarations, external review.
...
: Internal rivalry that undermines collaboration and information sharing. **Remedy**: Team-based incentives, shared goals, cross-team reviews, and transparency.
