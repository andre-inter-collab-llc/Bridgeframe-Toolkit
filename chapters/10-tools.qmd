...
::: {.callout-tip title="Starting Small"}
...
| Organization Size | Recommended Approach | Key Tools |
|:------------------|:---------------------|:----------|
| **Individual analyst** | Organized folders with naming conventions | Excel, Python/R scripts, SQLite |
| **Small program** | Single PostgreSQL database with layered schemas | PostgreSQL, dbt, Python |
| **Medium health department** | Data warehouse with ETL pipeline | PostgreSQL/Snowflake, Airflow, dbt |
| **Large state/federal** | Full lakehouse architecture | Spark/Databricks, Delta Lake, Airflow, dbt |
